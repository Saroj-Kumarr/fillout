...
export default function WorkspaceModal({ children }: WorkspaceModalProps) {
  const [searchQuery, setSearchQuery] = useState("");

  const actions = [
    { label: "New form", icon: FileText, color: "text-blue-600" },
    { label: "New scheduler", icon: Calendar, color: "text-orange-600" },
    { label: "New Zite", icon: Square, color: "text-gray-800" },
  ];

  const navigationItems = [
    {
      label: "Sign Up Sheet Template",
      sublabel: "Home",
      icon: FileText,
      color: "text-blue-600",
    },
            ...
            <div className="flex items-center gap-3">
              <div className="relative flex-1">
                ...
                <Input
                  ...
                  className="pl-10 bg-transparent border-none shadow-none outline-none ring-0 focus:border-none focus:outline-none focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0"
                />
              </div>
              <DropdownMenu>
