...
import CreateOrganizationModal from "../modals/CreateOrganization";
import WorkspaceModal from "../modals/WorkspaceModal";
import CreateWorkspace from "../modals/CreateWorkspace";
import { ReferralModal } from "../modals/ReferralModal";
import { HelpDropdown } from "../modals/HelpDropdown";
import PricingModal from "../modals/PriceModal";
...
const Sidebar = () => {
  ...
  return (
    <div className="w-64 bg-[#FBFBFB] min-h-screen flex flex-col">
      {/* User Profile Section */}
      <div className="p-4">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <div className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors">
              <Avatar className="w-8 h-8 rounded-md bg-[#5C6BC0] text-white">
                <AvatarFallback className="bg-[#5C6BC0] text-white text-sm rounded-md font-medium">
                  S
                </AvatarFallback>
              </Avatar>
          ...
          >
            ...
            <DropdownMenuItem className="flex items-center gap-3 px-2 py-2 rounded-md cursor-pointer">
              <Avatar className="w-6 h-6 rounded-md bg-[#5C6BC0] text-white">
                <AvatarFallback className="bg-[#5C6BC0] text-white text-xs font-medium rounded-md">
                  S
                </AvatarFallback>
              </Avatar>
              <div className="flex-1 min-w-0">
                <div className="text-sm font-medium text-gray-900 truncate">
                  {"Saroj Kumar's organizat..."}
                </div>
                <div className="text-xs text-gray-500">Free • 1 member</div>
              </div>
            ...
            <DropdownMenuItem className="flex items-center gap-3 px-2 py-2 rounded-md cursor-pointer">
              ...
              <span className="text-sm text-gray-700">Conversion kit</span>
            </DropdownMenuItem>
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <div className="px-4">
            <Button className="w-full bg-[#333333] text-white rounded-lg h-9">
              <Plus className="w-4 h-4" />
              Create
            </Button>
          </div>
        </DropdownMenuTrigger>
        <DropdownMenuContent align="start" className="w-48 p-1 ml-8">
      ...
      <WorkspaceModal>
        <div className="px-4 pb-4">
          <div className="relative rounded-md px-2 py-1 mt-2">
      ...
      <div className="px-4 pb-6">
        <div className="">
          <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-gray-200 text-gray-900 cursor-pointer">
            <Home className="w-4 h-4" />
            <span className="text-sm font-medium">Home</span>
          </div>
          <div className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 text-gray-700 cursor-pointer transition-colors">
      ...
      <div className="px-4 pb-6">
        <div className="flex items-center justify-between">
          <div className="text-sm font-medium text-gray-600 mb-3 px-3">
            Workspaces
          </div>
          <CreateWorkspace>
        ...
        <div className="flex items-center justify-between px-3 py-2 rounded-lg hover:bg-gray-100 text-gray-700 cursor-pointer transition-colors">
      ...
      <div className="px-4 pb-4">
        <div className="space-y-1">
          <div
            ...
            className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 text-gray-700 cursor-pointer transition-colors"
          >
            <Calendar className="w-4 h-4" />
            <span className="text-sm font-medium">Get free Zite credits</span>
          </div>
          <div className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 text-gray-700 cursor-pointer transition-colors">
      ...
      {/* Upgrade Button */}
      <div onClick={() => setOpenPriceModal(true)} className="px-4 pb-4">
        <Button
          variant="outline"
          className="w-full border-2 border-yellow-500 bg-[#FDEFCE] hover:bg-[#FDEFCE] text-gray-900 rounded-lg h-10"
        >
      ...
      <ReferralModal open={openReferral} onOpenChange={setOpenReferral} />
      <PricingModal
